...
import { createBlog, getAllBlogs, getBlogById, updateBlog, deleteBlog, searchBlog, editState } from '../controllers/blogController.js';
...
// edit blog state
router.patch('/blog/edit/:_id', requireSignedIn, requireBlogAuthor, editState);
